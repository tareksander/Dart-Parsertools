...
class Rule {
  ...
  /// Because builders can't get the ordering of methods reliably, this establishes an ordering.
  /// That means no rules in a parser can have the same priority, it results in a generator error.
  final int priority;
